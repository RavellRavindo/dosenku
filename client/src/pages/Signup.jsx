    ...
    <div className="w-full h-screen flex items-start">
      ...
      <div className="w-1/2 h-full flex flex-col p-20 bg-white rounded-xl">
        ...
        <form className="w-full flex flex-col px-12 pt-3" action="">
          ...
          <input type="text" placeholder='Fullname' className="block w-full rounded-md border-0 py-3 pl-4 pr-10 ring-1 ring-black" />
          ...
          <input type="text" placeholder='+62' className="block w-full rounded-md border-0 py-3 pl-4 pr-10 ring-1 ring-black" />
          <label className='font-semibold pb-1 pt-4' htmlFor="">School/Universities</label>
          <input type="text" placeholder='Universities...' className="block w-full rounded-md border-0 py-3 pl-4 pr-10 ring-1 ring-black" />
          ...
          <input type="text" placeholder='Confirm Password' className="block w-full rounded-md border-0 py-3 pl-4 pr-10 ring-1 ring-black" />
